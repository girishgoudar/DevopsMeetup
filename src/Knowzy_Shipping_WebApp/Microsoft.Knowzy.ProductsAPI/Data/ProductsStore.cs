...
namespace Microsoft.Knowzy.ProductsAPI.Data
{
    public class ProductsStore : IProductsStore
    {
        ...
        public ProductsStore(IConfiguration config)
        {
            ...
            _productsLink = UriFactory.CreateDocumentCollectionUri("devopsmeetupcosmosdb", "products");
        ...
        {
            await _client.DeleteDocumentAsync(UriFactory.CreateDocumentUri("devopsmeetupcosmosdb", "products", productId));
        }

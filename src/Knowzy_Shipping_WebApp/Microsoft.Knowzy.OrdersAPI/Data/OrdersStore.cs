...
namespace Microsoft.Knowzy.OrdersAPI.Data
{
    public class OrdersStore : IOrdersStore
    {
        ...
        public OrdersStore(IConfiguration config)
        {
            ...
            _ordersLink = UriFactory.CreateDocumentCollectionUri("devopsmeetupcosmosdb", "orders");
        ...
        {
            await _client.DeleteDocumentAsync(UriFactory.CreateDocumentUri("devopsmeetupcosmosdb", "orders", orderId));
        }

...
namespace Microsoft.Knowzy.CustomersAPI.Data
{
    public class CustomersStore : ICustomersStore
    {
        ...
        public CustomersStore(IConfiguration config)
        {
            ...
            _customersLink = UriFactory.CreateDocumentCollectionUri("devopsmeetupcosmosdb", "customers");
        ...
        {
            await _client.DeleteDocumentAsync(UriFactory.CreateDocumentUri("devopsmeetupcosmosdb", "customers", customerId));
        }
